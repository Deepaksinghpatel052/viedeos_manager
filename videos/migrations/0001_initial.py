# Generated by Django 3.0.4 on 2020-05-14 10:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Videos_Slug', models.CharField(max_length=500)),
                ('Video', models.FileField(null=True, upload_to=videos.models.user_directory_path)),
                ('Video_thumbnail', models.ImageField(null=True, upload_to=videos.models.user_directory_path_thumbnail)),
                ('Publich_Status', models.BooleanField(default=True)),
                ('Description', models.TextField(blank=True, null=True)),
                ('Meta_Title', models.CharField(max_length=200)),
                ('Meta_keyword', models.CharField(max_length=120)),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name_plural': 'VS Reating',
            },
        ),
        migrations.CreateModel(
            name='VsComments',
